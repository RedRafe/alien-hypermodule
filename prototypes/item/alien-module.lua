...
data:extend({
	{
		type = "module",
		name = "alien-module-1",
		icon = "__alien-hypermodule__/graphics/alien-module-1.png",
		icon_size = 32,
		subgroup = "module-alien",
		category = "module-alien",
		tier = 1,
		order = "a-1",
		stack_size = 50,
		effect = {
...
data:extend({
	{
		type = "module",
		name = "alien-module-2",
		icon = "__alien-hypermodule__/graphics/alien-module-2.png",
		icon_size = 32,
		subgroup = "module-alien",
		category = "module-alien",
		tier = 2,
...
data:extend({
	{
		type = "module",
		name = "alien-module-3",
		icon = "__alien-hypermodule__/graphics/alien-module-3.png",
		icon_size = 32,
		subgroup = "module-alien",
		category = "module-alien",
		tier = 3,
...
data:extend({
	{
		type = "module",
		name = "alien-module-4",
		icon = "__alien-hypermodule__/graphics/alien-module-4.png",
		icon_size = 32,
		subgroup = "module-alien",
		category = "module-alien",
		tier = 4,
...
data:extend({
	{
		type = "module",
		name = "alien-module-5",
		icon = "__alien-hypermodule__/graphics/alien-module-5.png",
		icon_size = 32,
		subgroup = "module-alien",
		category = "module-alien",
		tier = 5,
